        ...
        <View className='bg-[#262135] w-full h-full text-white '>
            ...
            <View className='px-8'>
                ...
                <View className='w-full  bg-[#494358] rounded-[30px]'>
                    <TouchableOpacity onPress={handleAccountInfo} className=' h-20 w-[90%] mx-auto flex flex-row justify-between px-4 items-center border-b-2 border-gray-400 '>
                        <Text className='font-JakartaSemiBold text-white' >Account Information</Text>

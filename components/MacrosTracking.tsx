...
const MacrosTracking: React.FC<MacrosTrackingProps> = ({ onMealLogged }) => {
		...
		<View className="w-full">
			<View className="flex flex-row justify-between items-center px-4">
				...
				<View className="flex flex-row items-center gap-2">
					<Text className="text-[#E3BBA1] text-xs font-JakartaSemiBold">
						{nutritionGoals ? 'Personal Goals' : 'Average Goals'}
					</Text>
					<TouchableOpacity
